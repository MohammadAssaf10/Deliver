...
class _$GetTripHistories extends GetTripHistories {
  ...
  bool operator ==(Object other) {
    ...
    return other is GetTripHistories;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'GetTripHistories').toString();
  }
}

class GetTripHistoriesBuilder
    implements Builder<GetTripHistories, GetTripHistoriesBuilder> {
  _$GetTripHistories? _$v;

  GetTripHistoriesBuilder();
  ...
  @override
  void update(void Function(GetTripHistoriesBuilder)? updates) {
