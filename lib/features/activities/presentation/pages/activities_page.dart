                            ...
                            child: Column(
                              ...
                              children: [
                                TripTile(
                                  ...
                                  subtitle: state.tripHistories.items[index].id
                                      .toString(),
                                ...
                                TripTile(
                                  ...
                                  subtitle: state
                                      .tripHistories.items[index].status.name,
                                  icon: Icons.info_outline,
                                ),
                                TripTile(
                                  title: S.of(context).estimatedTime,
                                  subtitle: S.of(context).minute(state
                                      .tripHistories
                                      .items[index]
                                      .calculatedDuration
                                      .removeDecimalZero()),
                                ...
                                TripTile(
                                  ...
                                  subtitle: S.of(context).km(state.tripHistories
                                      .items[index].calculatedDistance
                                      .removeDecimalZero()),
                                ...
                                TripTile(
                                  ...
                                  subtitle: state
                                      .tripHistories.items[index].createdDate
