...
import 'package:flutter_map/flutter_map.dart' as _i7;
...
import '../../features/maps/presentation/bloc/map_bloc.dart' as _i19;
...
import '../../features/register/domain/repositories/register_repository.dart'
    as _i10;
import '../../features/register/presentation/bloc/register_bloc.dart' as _i20;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i6.LoginRemoteDataSource>(
      () => _i6.LoginRemoteDataSource(gh<_i4.FirebaseAuth>()));
  gh.lazySingleton<_i7.MapController>(() => registerModule.mapController);
  gh.lazySingleton<_i8.NetworkInfo>(
      () => _i8.NetworkInfoImpl(gh<_i3.Connectivity>()));
  gh.lazySingleton<_i9.RegisterRemoteDataSource>(
      () => _i9.RegisterRemoteDataSource(gh<_i4.FirebaseAuth>()));
  ...
  gh.factory<_i19.MapBloc>(() => _i19.MapBloc(
        gh<_i7.MapController>(),
        gh<_i5.Location>(),
      ));
  gh.factory<_i20.RegisterBloc>(
      () => _i20.RegisterBloc(gh<_i10.RegisterRepository>()));
  gh.lazySingleton<_i21.AppCubit>(
      () => _i21.AppCubit(gh<_i15.AppRepository>()));
  gh.factory<_i22.LoginBloc>(() => _i22.LoginBloc(gh<_i17.LoginRepository>()));
  return getIt;
}
