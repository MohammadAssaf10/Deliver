...
class TextStyles {
  ...
  static TextStyle font16DarkGreySemiBold = const TextStyle(
    fontSize: 16,
  ...
  static TextStyle font16DarkGreyRegular = const TextStyle(
    fontSize: 16,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.darkGrey,
  );
  static TextStyle font16DarkWhiteRegular = const TextStyle(
    fontSize: 16,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.darkWhite,
  );
  ...
  static TextStyle font18DarkGreyBold = const TextStyle(
    fontSize: 18,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.darkGrey,
  );
